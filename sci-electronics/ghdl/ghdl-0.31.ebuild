...
HOMEPAGE="http://sourceforge.net/projects/ghdl-updates/"
SRC_URI="http://downloads.sourceforge.net/project/ghdl-updates/Source/${P}.tar.gz
...
src_unpack() {
	unpack gcc-${GCC_VERSION}.tar.bz2
	mkdir ${WORKDIR}/${PN}
	cd ${WORKDIR}/${PN}
	unpack ${P}.tar.gz
}
